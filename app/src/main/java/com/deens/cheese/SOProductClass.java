...
public class SOProductClass {
    ...
    public SOProductClass(int productID, String companyName, String productCode, String productName,
                          Double productSalaPrice, String productType, String productUnit, Double tradeOffer, Double discount) {
        ProductID = productID;

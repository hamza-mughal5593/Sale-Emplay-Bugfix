...
public class SOInvoiceDetailAdapter extends ArrayAdapter<ProductDetailClass> {
    ...
    public SOInvoiceDetailAdapter(ArrayList<ProductDetailClass> data, Context context) {
        super(context, R.layout.so_invoice_item, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SOInvoiceDetailAdapter.ViewHolder viewHolder; // view lookup cache stored in tag

        final View result;

        if (convertView == null) {

            viewHolder = new SOInvoiceDetailAdapter.ViewHolder();
            LayoutInflater inflater = LayoutInflater.from(getContext());
            convertView = inflater.inflate(R.layout.so_invoice_item, parent, false);
            ...
            viewHolder = (SOInvoiceDetailAdapter.ViewHolder) convertView.getTag();
            result=convertView;
        }
        ...
        viewHolder.discountDetail.setText("(Trade Offer: " + String.valueOf(dataModel.getOffer_Amt()).replace(".0", "") +" Rs. @ "
                + (dataModel.getTradeOffer()) + " Rs.)");

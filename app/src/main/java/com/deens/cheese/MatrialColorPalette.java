...
public class MatrialColorPalette {
    ...
    private static final List<MatrialColorPalette> MATERIAL_PALETTES;

    private static final Random RANDOM = new Random();

    static {
        MATERIAL_PALETTES = new ArrayList<>();
        MATERIAL_PALETTES.add(new MatrialColorPalette(RED_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(PINK_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(PURPLE_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(DEEP_PURPLE_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(INDIGO_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(BLUE_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(LIGHT_BLUE_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(CYAN_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(TEAL_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(GREEN_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(LIGHT_GREEN_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(LIME_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(YELLOW_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(AMBER_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(ORANGE_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(DEEP_ORANGE_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(BROWN_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(GREY_500));
        MATERIAL_PALETTES.add(new MatrialColorPalette(BLUE_GREY_500));
    }
     ...
     *     the 500 color
     */
    public MatrialColorPalette(int primary) {
